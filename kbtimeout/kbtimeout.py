...
weechat.register("kbtimeout", "kinabalu <andrew@mysticcoders.com>", "0.1", "GPL2", "kickban with timeout", "", "UTF-8")
weechat.charset_set("UTF-8")

weechat.hook_command("kbtimeout", "Kickban with ban timeout", "[nick] [timeout] [comment]", "kickban nick with comment", "", "handler", "")
weechat.hook_command("kbt", "Kickban with ban timeout (abbreviated version of /kbtimeout", "[nick] [timeout] [comment]", "kickban nick with comment", "", "handler", "")
